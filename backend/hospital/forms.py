...
class PatientAppointmentForm(forms.ModelForm):
    ...
    doctor.widget.attrs.update({'class': 'app-form-control'})
    calldate = forms.DateField(label='', widget=SelectDateWidget(years=range(2021, 2025)))
    calldate.widget.attrs.update({'class': 'app-form-control-date'})
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['calltime'].choices = [
            ('9:00 AM', '9:00 AM'), ('9:15 AM', '9:15 AM'), ('9:30 AM', '9:30 AM'), 
            ('9:45 AM', '9:45 AM'), ('10:00 AM', '10:00 AM'), ('10:15 AM', '10:15 AM'),
            ('10:30 AM', '10:30 AM'), ('10:45 AM', '10:45 AM'), ('11:00 AM', '11:00 AM'),
            ('11:15 AM', '11:15 AM'), ('11:30 AM', '11:30 AM'), ('11:45 AM', '11:45 AM'),
            ('12:00 PM', '12:00 PM'), ('12:15 PM', '12:15 PM'), ('12:30 PM', '12:30 PM'),
            ('12:45 PM', '12:45 PM'), ('14:00 PM', '14:00 PM'), ('14:15 PM', '14:15 PM'),
            ('14:30 PM', '14:30 PM'), ('14:45 PM', '14:45 PM'), ('15:00 PM', '15:00 PM'),
            ('15:15 PM', '15:15 PM'), ('15:30 PM', '15:30 PM'), ('15:45 PM', '15:45 PM'),
            ('16:00 PM', '16:00 PM'), ('16:15 PM', '16:15 PM'), ('16:30 PM', '16:30 PM'),
            ('16:45 PM', '16:45 PM'), ('17:00 PM', '17:00 PM')
        ]

    def clean_calltime(self):
        calltime = self.cleaned_data.get('calltime')
        try:
            # Convert time to standard format (HH:MM)
            time_obj = datetime.strptime(calltime, '%I:%M %p')
            return time_obj.strftime('%H:%M')
        except ValueError:
            raise forms.ValidationError('Invalid time format. Expected format is "9:00 AM".')
